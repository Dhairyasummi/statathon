...
if st.session_state.step == 2:
    ...
    # Next Button
    if st.button("Next: Null Value Handling"):
...
if st.session_state.step == 3:
    ...
    # Next Button
    if st.button("Next: Duplicate Handling"):
...
if st.session_state.step == 4:
    ...
    # Next Button
    if st.button("Next: Summary & Exportable Report"):
...
if st.session_state.step == 5:
    ...
    fig_nulls = None
     ...
     # Next Button
    if st.button("Next: Visualizations"):
...
if st.session_state.step == 6:
    ...
    # Next Button
    if st.button("Next: Insights & Conclusion"):
